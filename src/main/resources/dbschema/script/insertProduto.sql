...
--rollback DELETE FROM Produto WHERE pro_id = 01;
--rollback DELETE FROM Produto WHERE pro_id = 02;
--rollback DELETE FROM Produto WHERE pro_id = 03;
--rollback DELETE FROM Produto WHERE pro_id = 04;
--rollback DELETE FROM Produto WHERE pro_id = 05;
--rollback DELETE FROM Produto WHERE pro_id = 06;
--rollback DELETE FROM Produto WHERE pro_id = 07;
--rollback DELETE FROM Produto WHERE pro_id = 08;
--rollback DELETE FROM Produto WHERE pro_id = 09;
--rollback DELETE FROM Produto WHERE pro_id = 10;
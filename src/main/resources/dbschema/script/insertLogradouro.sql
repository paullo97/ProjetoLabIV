...
--rollback DELETE FROM Logradouro WHERE log_cep = 12210090;
--rollback DELETE FROM Logradouro WHERE log_cep = 12210905;
--rollback DELETE FROM Logradouro WHERE log_cep = 29112130;
--rollback DELETE FROM Logradouro WHERE log_cep = 74920020;
--rollback DELETE FROM Logradouro WHERE log_cep = 76860000;
--rollback DELETE FROM Logradouro WHERE log_cep = 38540970;
--rollback DELETE FROM Logradouro WHERE log_cep = 90001970;